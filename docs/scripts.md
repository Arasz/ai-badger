...
| `convert_mcp_prerequisites.py` | Convert legacy MCP prerequisite declarations into structured local/global definitions. | `python3 tooling/convert_mcp_prerequisites.py` |
