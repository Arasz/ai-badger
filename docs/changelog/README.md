...
| Version | Entry |
|---|---|
| 0.53.0 | [personas reach Claude Code](0.53.0-personas-reach-claude-agents.md) · [the index row stops being hand-written](0.53.0-the-index-row-stops-being-hand-written.md) · [the skills nobody here uses](0.53.0-the-skills-nobody-here-uses.md) |
