...
| Version | Entry |
|---|---|
| 0.48.0 | [a Copilot hook event stops overwriting its neighbour](0.48.0-a-copilot-hook-event-stops-overwriting-its-neighbour.md) · [the MCP tool index becomes JSON, and the hook stops importing yaml](0.48.0-mcp-tools-json.md) |
