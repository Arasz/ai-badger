...
| Version | Entry |
|---|---|
| 0.51.0 | [six tests that could not pass alone](0.51.0-six-tests-that-could-not-pass-alone.md) · [a build is not a dotnet](0.51.0-a-build-is-not-a-dotnet.md) · [.mcp.json stops shipping](0.51.0-mcp-json-stops-shipping.md) |
