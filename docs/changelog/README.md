...
| Version | Entry |
|---|---|
| 0.47.0 | [the scaffold detects itself](0.47.0-the-scaffold-detects-itself.md) · [Junie can finally see the skills ai-badger claimed to give it](0.47.0-junie-can-see-skills.md) · [retrieval tells you what it did, and a redact switch for the query](0.47.0-retrieval-tells-you-what-it-did.md) |
