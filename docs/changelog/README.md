...
| Version | Entry |
|---|---|
| 0.51.0 | [six tests that could not pass alone](0.51.0-six-tests-that-could-not-pass-alone.md) · [a build is not a dotnet](0.51.0-a-build-is-not-a-dotnet.md) · [.mcp.json stops shipping](0.51.0-mcp-json-stops-shipping.md) · [`mcp` becomes a catalog feature type](0.51.0-mcp-becomes-a-catalog-feature-type.md) · [the MCP catalog carries the instructions](0.51.0-the-mcp-catalog-carries-the-instructions.md) · [one declaration set, three readers](0.51.0-one-declaration-set-three-readers.md) · [the legacy MCP registries are deleted](0.51.0-the-legacy-mcp-registries-are-deleted.md) |
