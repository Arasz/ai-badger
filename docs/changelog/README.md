...
| Version | Entry |
|---|---|
| 0.51.0 | [six tests that could not pass alone](0.51.0-six-tests-that-could-not-pass-alone.md) · [`mcp` becomes a catalog feature type](0.51.0-mcp-becomes-a-catalog-feature-type.md) |
