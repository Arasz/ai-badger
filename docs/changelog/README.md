...
| Version | Entry |
|---|---|
| 0.53.0 | [entry titles carry their casing and 0.51.0's build order](0.53.0-entry-titles-carry-their-meaning.md) · [one declaration per server, per host](0.53.0-one-declaration-per-server-per-host.md) · [the log a failing push cites tells the truth](0.53.0-the-cited-log-tells-the-truth.md) · [the index row stops being hand-written](0.53.0-the-index-row-stops-being-hand-written.md) · [the skills nobody here uses](0.53.0-the-skills-nobody-here-uses.md) |
