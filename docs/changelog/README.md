...
| Version | Entry |
|---|---|
| 0.51.0 | [six tests that could not pass alone](0.51.0-six-tests-that-could-not-pass-alone.md) · [a build is not a dotnet](0.51.0-a-build-is-not-a-dotnet.md) · [.mcp.json stops shipping](0.51.0-mcp-json-stops-shipping.md) · [`mcp` becomes a catalog feature type](0.51.0-mcp-becomes-a-catalog-feature-type.md) |
| 0.50.0 | [context-enrichment reaches Claude and Copilot, unconditionally](0.50.0-context-enrichment-reaches-claude-and-copilot.md) · [the gap is answerability, not vocabulary](0.50.0-the-gap-is-answerability-not-vocabulary.md) · [what the MCP tool index is for](0.50.0-what-the-mcp-tool-index-is-for.md) · [the stopword-count comment was wrong](0.50.0-stopword-count-comment-was-wrong.md) · [MCP support is configuration, not retrieval](0.50.0-mcp-support-is-configuration-not-retrieval.md) · [the coverage gate stops scaling with query length](0.50.0-the-coverage-gate-stops-scaling-with-query-length.md) · [the checkpoint hook users had to wire themselves](0.50.0-the-checkpoint-hook-users-had-to-wire-themselves.md) |
