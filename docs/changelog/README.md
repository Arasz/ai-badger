...
| Version | Entry |
|---|---|
| 0.47.0 | [retrieval tells you what it did, and a redact switch for the query](0.47.0-retrieval-tells-you-what-it-did.md) · [a missing pyyaml no longer takes four hooks down with it](0.47.0-a-missing-package-stops-taking-four-hooks-with-it.md) |
