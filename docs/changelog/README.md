...
| Version | Entry |
|---|---|
| 0.172.16 | [candidate stacks are tracked-and-present; archify exemptions need a vendor marker](0.172.16-candidate-stacks-and-archify-exemption.md) |
...
| 0.157.2 | [pi instructions session-format reference fix](0.157.2-pi-instructions-session-format-reference-fix.md) |
...
| 0.140.0 | [Git owns its own storage](0.140.0-git-owns-its-own-storage.md) · [Hermes cannot be gated per dispatch, and its isolation switch is off by default](0.140.0-hermes-cannot-be-gated-per-dispatch.md) · [Task skill default loop: effort levels, MoE panels, task-ID derivation](0.140.0-task-skill-default-loop.md) |
...
| 0.135.0 | [Research-based prompt and persona optimization](0.135.0-research-based-prompt-optimization.md) |
| 0.134.1 | [Path sanitization centralization & Copilot review fixes for #427](0.134.1-semantica-nudge-review-fixes.md) |
