...
> Scaffolded by ai-badger 0.172.10. Regenerated on every scaffold; do not edit.
...
- `hermes-agent-author` — Hermes Agent skill and configuration author. Level: medium, Lane: sonnet.
