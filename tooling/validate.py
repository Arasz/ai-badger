...
FEATURE_JSON_WITHOUT_SCHEMA: Dict[str, str] = {
    ...
    "features/*/subagent/package.json":
        "pi subagent extension package.json — a pi extension manifest like the cron one "
        "above; pi discovers the extension by its index.ts, so this file is npm's contract, "
        "not ours",
