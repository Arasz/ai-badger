...
# (Joachims 2002). After memory_search: stash {correlationId, sourceFiles, ts}.
...
# Hermes keeps state in-process; Claude/Copilot use a shared file via
# the memory_grade_hook.py shell hook (hooks.json PostToolUse).
# ---------------------------------------------------------------------------
