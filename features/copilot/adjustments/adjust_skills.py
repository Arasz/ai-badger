...
def adjust(context: Dict[str, Any]) -> Dict[str, Any]:
    ...
    pruned = _prune(github_skills, skills, skills_root, owned_targets) if may_prune else []
    left = [] if may_prune else _owned_entries(github_skills, skills_root, owned_targets)
