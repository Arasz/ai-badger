...
```csharp
private the encryption commands ValidCtorArgs(SqliteConnectionFactory? bank = null, ...) =>
...
public void Constructor_NullBank_ThrowsArgumentNullException()
{
    var ex = Should.Throw<ArgumentNullException>(() =>
        new the encryption commands(null!,
...
private const string InvalidPracticeSessionTransitionType = "https://the reference repo.dev/problems/invalid-practice-session-transition";
```
