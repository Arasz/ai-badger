...
- *review:* three cross-cutting rules in jsaa could not have fired from their host project at all, because that project referenced neither the logging nor the persistence SDK they forbade.
