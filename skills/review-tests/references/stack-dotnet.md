...
- **severity:** major · **evidence:** strong
...
- **severity:** minor · **evidence:** strong
...
- *check:* argued.
- **severity:** minor · **evidence:** strong
- *parent:* `T1-PRF-04` · *absorbs:* `N-MUT-03` · *cites:* `evidence.md` (stryker-blind-spots); jsaa ADR-0057
